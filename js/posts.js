  ...
  var element = (
    <section className="posts_section">
      ...
      <ol>
        ...
        <br/>
        <li className="postsText">Learning is the continuous discovery of your own ignorance.</li>
        <br/>
        <li className="postsText">Life breaks all of us, but the strong get stronger in the broken places.</li>
        <br/>
        ...
        <br/>
        <li className="postsText">Use your fear. It can take you to a place where your courage is stored.</li>
        <br/>
        <li className="postsText">If there is something worthy you want, it's not something you can accomplish in one day.  It doesn't matter your pace, and it doesn't matter your strengths or weaknesses, as long as you keep pushing forward, you are achieving something.</li>
        <br/>
        <li className="postsText">There are no limits. There are only plateaus, and you must not stay there.  You must go beyond them.</li>
        <br/>
